...
def handle_data(data, old_data, la, lb, lz):
    ...
    if len(old_data_copy[0]) < 5:
        # print('less than 5', old_data_copy)
        # print(lz)
        ...
        data_delta = (ax_new_av - ax_old_av, ay_new_av - ay_old_av, az_new_av - az_old_av)
        new_lz = data_handler(data_delta, lz, la, lb)
        # dt = 0.1
        # move_mouse(ax_new_av - ax_old_av, ay_new_av - ay_old_av, az_new_av - az_old_av, dt)

        return [new_x, new_y, new_z], new_lz
